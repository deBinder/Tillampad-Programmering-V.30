...
$ageSleepArr1 = array(array('Age', 'SleepTime')); // Array to store Age and BMI



$bubbleArr = array(array('Sex', 'AgeCategory', 'PhysicalHealth','HeartDisease','MentalHealth')); // Array to store Age and BMI
...
foreach($data as $key => $value) { // Används bl.a som en COUNT funktion för graf 1 och 2.
  ...
  if($value['AgeCategory'] == "18-24") {
    ...
    $bubbleArr[] = array((object)['v' => 22, 'f' => $value['Sex']], strval($value['AgeCategory']), strval($value['PhysicalHealth']), strval($value['HeartDisease']), strval($value['PhysicalHealth']));
    $agecat1++;
  }
  if($value['AgeCategory'] == "25-29") {
    $ageSleepArr[] = array((object)['v' => 27, 'f' => $value['AgeCategory']], floatval($value['SleepTime']));
    $bubbleArr[] = array((object)['v' => 27, 'f' => $value['Sex']], strval($value['AgeCategory']), strval($value['PhysicalHealth']), strval($value['HeartDisease']), strval($value['PhysicalHealth']));
    $agecat2++;
  }
  if($value['AgeCategory'] == "30-34") {
    $ageSleepArr[] = array((object)['v' => 32, 'f' => $value['AgeCategory']], floatval($value['SleepTime']));
    $bubbleArr[] = array((object)['v' => 32, 'f' => $value['Sex']], strval($value['AgeCategory']), strval($value['PhysicalHealth']), strval($value['HeartDisease']), strval($value['PhysicalHealth']));
    $agecat3++;
  }
  if($value['AgeCategory'] == "35-39") {
    $ageSleepArr[] = array((object)['v' => 37, 'f' => $value['AgeCategory']], floatval($value['SleepTime']));
    $bubbleArr[] = array((object)['v' => 37, 'f' => $value['Sex']], strval($value['AgeCategory']), strval($value['PhysicalHealth']), strval($value['HeartDisease']), strval($value['PhysicalHealth']));
    $agecat4++;
  }
  if($value['AgeCategory'] == "40-44") {
    $ageSleepArr[] = array((object)['v' => 42, 'f' => $value['AgeCategory']], floatval($value['SleepTime']));
    $bubbleArr[] = array((object)['v' => 42, 'f' => $value['Sex']], strval($value['AgeCategory']), strval($value['PhysicalHealth']), strval($value['HeartDisease']), strval($value['PhysicalHealth']));
    $agecat5++;
  }
  if($value['AgeCategory'] == "45-49") {
    $ageSleepArr[] = array((object)['v' => 47, 'f' => $value['AgeCategory']], floatval($value['SleepTime']));
    $bubbleArr[] = array((object)['v' => 47, 'f' => $value['Sex']], strval($value['AgeCategory']), strval($value['PhysicalHealth']), strval($value['HeartDisease']), strval($value['PhysicalHealth']));
    $agecat6++;
  }
  if($value['AgeCategory'] == "50-54") {
    $ageSleepArr[] = array((object)['v' => 52, 'f' => $value['AgeCategory']], floatval($value['SleepTime']));
    $bubbleArr[] = array((object)['v' => 52, 'f' => $value['Sex']], strval($value['AgeCategory']), strval($value['PhysicalHealth']), strval($value['HeartDisease']), strval($value['PhysicalHealth']));
    $agecat7++;
  }
  if($value['AgeCategory'] == "55-59") {
    $ageSleepArr[] = array((object)['v' => 57, 'f' => $value['AgeCategory']], floatval($value['SleepTime']));
    $bubbleArr[] = array((object)['v' => 57, 'f' => $value['Sex']], strval($value['AgeCategory']), strval($value['PhysicalHealth']), strval($value['HeartDisease']), strval($value['PhysicalHealth']));
    $agecat8++;
  }
  if($value['AgeCategory'] == "60-64") {
    $ageSleepArr[] = array((object)['v' => 62, 'f' => $value['AgeCategory']], floatval($value['SleepTime']));
    $bubbleArr[] = array((object)['v' => 62, 'f' => $value['Sex']], strval($value['AgeCategory']), strval($value['PhysicalHealth']), strval($value['HeartDisease']), strval($value['PhysicalHealth']));
    $agecat9++;
  }
  if($value['AgeCategory'] == "65-69") {
    $ageSleepArr[] = array((object)['v' => 67, 'f' => $value['AgeCategory']], floatval($value['SleepTime']));
    $bubbleArr[] = array((object)['v' => 67, 'f' => $value['Sex']], strval($value['AgeCategory']), strval($value['PhysicalHealth']), strval($value['HeartDisease']), strval($value['PhysicalHealth']));
    $agecat10++;
  }
  if($value['AgeCategory'] == "70-74") {
    $ageSleepArr[] = array((object)['v' => 72, 'f' => $value['AgeCategory']], floatval($value['SleepTime']));
    $bubbleArr[] = array((object)['v' => 72, 'f' => $value['Sex']], strval($value['AgeCategory']), strval($value['PhysicalHealth']), strval($value['HeartDisease']), strval($value['PhysicalHealth']));
    $agecat11++;
  }
  if($value['AgeCategory'] == "75-79") {
    $ageSleepArr[] = array((object)['v' => 77, 'f' => $value['AgeCategory']], floatval($value['SleepTime']));
    $bubbleArr[] = array((object)['v' => 77, 'f' => $value['Sex']], strval($value['AgeCategory']), strval($value['PhysicalHealth']), strval($value['HeartDisease']), strval($value['PhysicalHealth']));
    $agecat12++;
  }
  if($value['AgeCategory'] == "80 or older") {
    $ageSleepArr[] = array((object)['v' => 82, 'f' => $value['AgeCategory']], floatval($value['SleepTime']));
    $bubbleArr[] = array((object)['v' => 82, 'f' => $value['Sex']], strval($value['AgeCategory']), strval($value['PhysicalHealth']), strval($value['HeartDisease']), strval($value['PhysicalHealth']));
    $agecat13++;
  }
