...
// Piechart, info på sidan, fo till det
...
<button id="change-chart">Change to..</button>
    <br><br>
<div id="piechart2box" style="float:left; display: inline-block;"><div id="piechart2" style="display: inline-block; float:left; width: 600px; height: 500px;"></div></div><!-- Graph 2 -->

<button id="change-chart2">Change to..</button>
    <br><br>
<div id="piechart3box" style="float:left; display: inline-block;"><div id="piechart3" style="display: inline-block; float:left; width: 600px; height: 500px;"></div></div><!-- Graph 2 -->
</div>
</div>
</div>
